        ...
        public static IList<Racer> GetChampion()
        {
            if (racers == null)
            {
                racers = new List<Racer>(40)
                {
                    ...
                    new Racer("Jack", "Brabham", "Australia", 125, 14, new int[] {1959, 1960, 1966},
                    ...
                    new Racer("Jackie", "Stewart", "UK", 99, 27, new int[] {1969, 1971, 1973},
                        new string[] {"Matra", "Tyrrell"}),
                    new Racer("Emerson", "Fittipaldi", "Brazil", 143, 14, new int[] {1972, 1974},
                        new string[] {"Lotus", "McLaren"}),
                    ...
                    new Racer("Niki", "Lauda", "Austria", 173, 25, new int[] {1975, 1977, 1984},
                        new string[] {"Ferrari", "McLaren"}),
                    new Racer("Nelson", "Piquet", "Brazil", 204, 23, new int[] {1981, 1983, 1987},
                        new string[] {"Brabham", "Williams"}),
                    new Racer("Ayrton", "Senna", "Brazil", 161, 41, new int[] {1988, 1990, 1991},
                        new string[] {"McLaren"}),
                    new Racer("Nigel", "Mansell", "UK", 187, 31, new int[] {1992}, new string[] {"Williams"}),
                    new Racer("Alain", "Prost", "France", 197, 51, new int[] {1985, 1986, 1989, 1993},
                        new string[] {"McLaren", "Williams"}),
                    ...
                    new Racer("Michael", "Schumacher", "Germany", 287, 91,
                        new int[] {1994, 1995, 2000, 2001, 2002, 2003, 2004}, new string[] {"Benetton", "Ferrari"}),
                    new Racer("Fernando", "Alonso", "Spain", 177, 27, new int[] {2005, 2006}, new string[] {"Renault"}),
                    new Racer("Kimi", "Green", "Finland", 148, 17, new int[] {2007}, new string[] {"Ferrari"}),
                    new Racer("Lewis", "Hamilton", "UK", 90, 17, new int[] {2008}, new string[] {"McLaren"}),
                    new Racer("Jenson", "Button", "UK", 208, 12, new int[] {2009}, new string[] {"Brawn GP"}),
                    new Racer("Sebastian", "Vettel", "Germany", 81, 21, new int[] {2010, 2011},
                        new string[] {"Red Bull Racing"})
                };
            }
            return racers;
        }
        ...
        private static IList<Racer> GetMoreRacers()
        {
            if (moreRacers == null)
            {
                moreRacers = new List<Racer>
                {
                    ...
                    new Racer("Jose Froilan", "Gonzalez", "Argentina", starts: 26, wins: 2),
                    ...
                    new Racer("Felipe", "Massa", "Brazil", starts: 152, wins: 11),
                    new Racer("Mark", "Webber", "Australia", starts: 176, wins: 7)
                };
            }
            return moreRacers;
        }
